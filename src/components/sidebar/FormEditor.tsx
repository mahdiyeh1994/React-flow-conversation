...
export const FormEditor: React.FC<FormEditorProps> = ({ node }) => {
  ...
  const handleChange = useCallback(
    (key: string, value: any) => {
      ...
      // Re-evaluate conditions after any change
      setTimeout(() => evaluateConditions(), 0);
    },
    [node.id, updateNodeData, evaluateConditions],
  );
      ...
      <div className="space-y-4">
        ...
        >
          <p className="text-xs text-blue-700">
            💡 <strong>Tip:</strong> Enter a numeric value in the Value field if
            this node will be evaluated by a condition.
          </p>
        </motion.div>
      </div>
    );
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <input
            ...
            onChange={(e) =>
              handleChange("compareValue", parseInt(e.target.value) || 0)
            }
        ...
        >
          ...
          <p className="text-xs text-purple-700">
            and this condition is value &gt; 10
          </p>
          <p className="text-xs text-purple-700 font-semibold">
            Then: TRUE path is activated ✓
          </p>
        </motion.div>
      </div>
    );
